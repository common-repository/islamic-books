...
function edc_books_options() {
	...
	<div class="wrap">
		...
		<p><?php _e('Copy shortcode and paste into post/page:', 'edc-books'); ?> <code>EDC_books[<?php echo $edc_category_id; ?>]</code> or <code>[islamic_books category_id=<?php echo $edc_category_id; ?>]</code></p>
